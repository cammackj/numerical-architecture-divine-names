...
The next two sections explain the numerical tools and the rules used to keep the forms consistent. The paper then turns to the places where the patterns meet: YHWH, Yeshua, Yeshua HaMashiach, Ehyeh Asher Ehyeh, Shaddai and El Shaddai, Elohim, shared-value titles, the values 22, 42, and 72, and the scroll construction. A final testing section asks how unusual the results are. The conclusion returns to the question that began the study: after the arithmetic is laid out, what kind of architecture does the reader see?
